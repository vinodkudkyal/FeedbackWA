...
const FacultyFilter = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      {/* <div className="flex min-h-screen bg-gradient-to-br from-blue-50 via-blue-50 to-pink-50"> */}
      {/* <AdminSidebar /> */}
      {!showDashboard ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {facultyData.length > 0 ? (
                  facultyData.map((faculty) => (
                    <div
                      key={faculty._id}
                      className="p-4 md:p-6 rounded-lg shadow-md transition-all hover:shadow-lg hover:scale-102 bg-white cursor-pointer"
