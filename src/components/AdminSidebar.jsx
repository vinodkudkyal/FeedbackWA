...
const AdminSidebar = () => {
  ...
  return (
    <motion.div
      ...
      // Become a fixed 64-width sidebar on md+ screens, but behave as a normal block (w-full) on small screens
      className="bg-white shadow-lg p-4 md:w-64 md:fixed md:h-screen w-full"
    >
