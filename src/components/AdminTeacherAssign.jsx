      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-8">
          ...
          <div>
            ...
            <select 
              className="w-full px-3 py-2 sm:px-4 sm:py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
          ...
          <Card className="p-4 md:p-6">
            ...
            <div className="space-y-4">
              {availableSubjects.map((subject) => (
                <div 
                  key={subject.code} 
                  className="bg-gray-50 p-3 md:p-4 rounded-xl flex items-center justify-between"
                >
                  <div>
          ...
          <Card className="p-4 md:p-6">
            ...
            <div className="space-y-4">
              {filteredTeachers.map((teacher) => (
                <div 
                  key={teacher.id} 
                  className="bg-gray-50 p-3 md:p-4 rounded-xl flex items-center"
                >
                  ...
                  <button 
                    className="bg-purple-100 text-purple-700 px-2 py-1 sm:px-3 sm:py-2 rounded-lg hover:bg-purple-200 transition-colors flex items-center text-sm"
                  >
                    Assign 
