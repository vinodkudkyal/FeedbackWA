    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex">
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-72 bg-white shadow-lg p-4 overflow-auto">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold">Menu</h2>
              <button onClick={() => setIsSidebarOpen(false)} aria-label="Close menu" className="p-2 rounded-md">
                <X />
              </button>
            </div>
            <AdminSidebar />
        ...
        >
          <div className="flex items-start justify-between mb-6">
            ...
            <div className="md:hidden">
              <button onClick={() => setIsSidebarOpen(true)} aria-label="Open menu" className="p-2 rounded-md bg-gray-100">
                <Menu />
              </button>
            </div>
          </div>
          ...
          {/* Filters */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 gap-3 mb-6">
            {/* Branch Filter */}
            <select
              value={branchFilter}
