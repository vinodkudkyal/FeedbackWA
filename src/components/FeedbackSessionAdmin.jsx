...
const FeedbackSessionAdmin = () => {
  ...
  useEffect(() => {
    const fetchSessions = async () => {
      try {
        const response = await fetch("https://feedbackend-mhol.onrender.com/api/sessions");
  ...
  const toggleSessionStatus = async (sessionId) => {
    try {
      ...
      const response = await fetch(
        `https://feedbackend-mhol.onrender.com/api/sessions/${sessionId}/status`,
        {
          method: "PATCH",
  ...
  const handleDeleteSession = async (sessionId) => {
    try {
      const response = await fetch(
        `https://feedbackend-mhol.onrender.com/api/sessions/${sessionId}`,
        { method: "DELETE" }
      );
