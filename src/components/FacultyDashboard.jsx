...
const FacultyFeedbackDashboard = ({ faculty }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex" ref={dashboardRef}>
      {/* Desktop Filters Column (hidden on small screens) */}
      <div className="hidden md:block w-64 bg-white shadow-sm p-6">
      ...
      <div className="flex-1 md:ml-64 p-4 md:p-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 sticky top-0 z-10">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="md:hidden">
                <button
                  ...
                  className="mr-2 p-2 rounded-md bg-gray-100"
                >
                  <Menu />
                </button>
              </div>
